    ...
    def dashboard(self) -> DashboardResponse:
        ...
        systems = [
            ...
            SystemStatus(
                ...
                state="operational",
                status="Operational",
                details_url=_append_path(self.settings.confluence_dsp_url, "systems/openshift"),
            ),
        ]
        ...
        return DashboardResponse(
            ...
            my_dsp=MyDspSummary(
                metrics=[
                    Metric(value=12, label="Jobs"),
                    Metric(value=3, label="Workspaces"),
                    Metric(value=2, label="Warnings"),
                    Metric(value=1, label="Failed"),
                ],
                active_resources=[
                    ResourceItem(
                        id="analytics-dev",
            ...
            upcoming_changes=[
                UpcomingChange(
                    ...
                    impact="Affects 2 of your workspaces",
                    state="needs_attention",
                    status="Impact",
